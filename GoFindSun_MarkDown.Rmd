...
##Klucz API do pobierania danych pogodowych:
```{r}
...
##Funkcja do sprawdzania aktualności danych
```{r}
...
```
#Pobieranie i przetwarzanie danych pogodowych
...
#Podsumowanie prognoz pogodowych
...
#Funkcje do punktacji pogodowej

## Logika wyboru funckji
...
##Funkcja punktacji rodzaju wyjazdu
...
##Fukcja do obliczania odległości (wzór Haversine)
